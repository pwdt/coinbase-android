...
import com.coinbase.android.BitcoinUri;
...
public class BitcoinUriTest extends TestCase {
  ...
  public void testParsing() throws Exception {
    ...
    assertEquals(new BigDecimal("2.0"), bitcoinUri.getAmount());
  ...
  public void testGenerating() throws Exception {
    ...
    uri.setAmount(new BigDecimal("2.0"));
    uri.setMessage("derp");
    uri.setLabel("theLabel");
    assertEquals("bitcoin:1NLsANR9nhi91CrekNPuvNoUy549cuEUZU?amount=2.00000000&message=derp&label=thelabel", uri.toUri());
  }
